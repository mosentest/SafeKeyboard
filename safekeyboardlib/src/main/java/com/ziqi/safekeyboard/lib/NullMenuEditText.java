...
public class NullMenuEditText extends AppCompatEditText {
    ...
    public NullMenuEditText(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public NullMenuEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
